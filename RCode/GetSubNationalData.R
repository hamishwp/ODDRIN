...
addODDPolygons <- function(ODDy, polygons_list){
  ...
  polygons_indexes <- remove_overlaps(polygons_indexes, polygons_list, ODDy@coords, ODDy)
...
remove_overlaps <- function(polygons_indexes, polygons_list, coords, ODDy){
